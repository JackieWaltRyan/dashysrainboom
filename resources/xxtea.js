...
(function (global) {
    ...
    function encrypt(data, key) {
        ...
        return toUint8Array(encryptInt32Array(toInt32Array(data, false), toInt32Array(key, false)), false);
    }
    ...
    function decrypt(data, key) {
		...
		//alert(decryptInt32Array(toInt32Array(data, false), toInt32Array(key, false)));
		//return "test";
        return toUint8Array(decryptInt32Array(toInt32Array(data, false), toInt32Array(key, false)), false);
    }
