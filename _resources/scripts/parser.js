...
function statistic() {
    try {
        ...
        setTimeout(() => {
            saveData = parser.parse(editor.getSession().getValue());
            ...
            setTimeout(() => {
                ...
                importData.appendChild(createElement("div", {
                    ...
                    try {
                        ...
                        if (saveData["mlp_save"]["playerdata"]["@_geolocationprompttime"] && /\d{10}/.test(saveData["mlp_save"]["playerdata"]["@_geolocationprompttime"])) {
                            times.push(parseInt(saveData["mlp_save"]["playerdata"]["@_geolocationprompttime"]));
                        }

                        if (saveData["mlp_save"]["playerdata"]["rating"]["@_timeratedgame"] && /\d{10}/.test(saveData["mlp_save"]["playerdata"]["rating"]["@_timeratedgame"])) {
                            times.push(parseInt(saveData["mlp_save"]["playerdata"]["rating"]["@_timeratedgame"]));
                        }

                        if (saveData["mlp_save"]["playerdata"]["rateusmanager"]["@_starttime"] && /\d{10}/.test(saveData["mlp_save"]["playerdata"]["rateusmanager"]["@_starttime"])) {
